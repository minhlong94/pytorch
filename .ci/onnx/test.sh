...
if [[ "$BUILD_ENVIRONMENT" == *onnx* ]]; then
  ...
  pip install -q --user ninja flatbuffers==2.0 numpy==1.22.4 beartype==0.10.4 onnx==1.12.0
  pip install -q --user coloredlogs==15.0.1
  pip install -q --user -i https://test.pypi.org/simple/ ort-nightly==1.14.0.dev20230119003
